  ...
  return (
    <header className="sticky top-0 z-50 bg-dark border-b border-gray-800">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        >
          <span
            className="hidden sm:block text-2xl font-bold bg-gradient-to-r from-neon-pink to-neon-blue 
          ...
          <span className="block sm:hidden leading-tight">
            <span
              className="text-lg font-bold bg-gradient-to-r from-neon-pink to-neon-blue 
                           text-transparent bg-clip-text"
            >
              I heard this live
            </span>
